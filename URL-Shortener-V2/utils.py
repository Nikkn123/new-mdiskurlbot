...
async def set_commands(app):
    COMMANDS = [
        BotCommand("start", "Check Alive Me"),
        BotCommand("about", "information about me"),
        #BotCommand("method", "Sets your preferred method."),
        BotCommand("shortener_api", "Set Your API."),
        #BotCommand("mdisk_api", "Sets the mDisk API."),
        BotCommand("header", "Add Your header "),
        BotCommand("footer", "Add Your Footer."),
        BotCommand("username", "For username"),
        BotCommand("banner_image", "Sets the banner image."),
        BotCommand("me", "Check About me "),
