...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5154193675:AAE2sU4FJe_RLIHopHxFD2799pgR9XTi80U")  # Bot token from @BotFather
ADMINS = (
...
OWNER_ID = int(os.environ.get("OWNER_ID", "5071094116"))  # id of the owner
...
BASE_SITE = os.environ.get("BASE_SITE", "mdiskurl.com")
