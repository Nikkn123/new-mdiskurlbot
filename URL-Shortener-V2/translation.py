...
`Developer:`MY Url Team
🌐 Source Code :`My father's Know's
"""
...
> `Mdiskurl` - Short all the links of the post to {shortener} link directly.
...
- 🌐 Shortener website: {base_site}
 ...
 Our Websites : Some site working Now beta mode 
...
- 📝Current Footer text: {footer_text}
...
Get your Mdisk API from Mdiskurl.com
...
Our Website: {base_site}

**To Set your Api, Go Our Mdiskurl : **
https://mdiskurl.com/member/tools/api/
